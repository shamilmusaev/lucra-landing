export const sv = {
  ...
  // ---- Blog ----
  blogMetaTitle: 'Blogg · Lucra',
  blogMetaDescription: 'Insikter om ekonomi, AI och redovisning för svenska företagare och redovisningsbyråer.',
  blogEyebrow: 'Blogg',
  blogTitle: 'Insikter om ekonomi och AI',
  blogSubtitle: 'Tankar, guider och perspektiv för svenska företagare och redovisningsbyråer.',
  blogEmpty: 'Inga artiklar publicerade ännu. Kom snart tillbaka.',
  blogReadArticle: 'Läs artikel',
  blogBackToBlog: 'Tillbaka till bloggen',
  blogReadingTimeSuffix: 'min läsning',
} as const;
