export const sv = {
  ...
  heroChatAutoQ: 'Vad är skillnaden mellan enskild firma och aktiebolag?',
  heroChatAutoA: '<strong>Enskild firma</strong> är du som verksamhet; <strong>aktiebolag (AB)</strong> är en egen juridisk person. De viktigaste skillnaderna:<ul><li><strong>Ansvar:</strong> i enskild firma är du personligt ansvarig för skulderna – i AB är ansvaret normalt begränsat till insatt kapital.</li><li><strong>Skatt:</strong> enskild firma beskattas som din inkomst; AB betalar bolagsskatt och du beskattas separat på lön eller utdelning.</li><li><strong>Administration:</strong> enskild firma är enklare och billigare att starta; AB kräver aktiekapital och mer formell bokföring.</li></ul>',
  ...
  heroDemoFilesTabUploaded: 'Uppladdade filer',
  heroDemoFilesTabGenerated: 'Genererade filer',
  heroDemoFilesStatsLabel: 'Filer',
  heroDemoFilesFortnox: 'Fortnox ansluten',
  ...
  heroCoTitle: 'Företag',
  heroCoSubtitle: 'Klientföretag din byrå är kopplad till. Varje koppling skapas när en kund accepterar din inbjudan.',
  heroCoColCompany: 'Företag',
  heroCoColOwner: 'Ägare',
  heroCoColStatus: 'Fortnox',
  heroCoColActivity: 'Senaste aktivitet',
  heroCoConnected: 'Ansluten',
  heroCoPending: 'Väntar',
  heroCoAct1: '2 tim sedan',
  heroCoAct2: 'Igår',
  heroCoAct3: '3 dagar sedan',
  heroCoAct4: 'Inbjudan skickad',
